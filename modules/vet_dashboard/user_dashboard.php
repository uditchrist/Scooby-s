...
?>
													...
													<div class="stat-panel-title text-uppercase">Status</div>
												</div>
											</div>
...
?>
													<div class="stat-panel-number h2 "><?php if($row['admin_approval'] == '0') {echo 'Waiting for admin';}
            else if($row['admin_approval'] == '1'){echo 'Approved';}
            else if($row['admin_approval'] == '2'){echo 'Rejected by Admin';}
             else{echo 'Pending';} ?></div>
													<div class="stat-panel-title text-uppercase">Admin's Approval Status</div>
												</div>
											</div>
...
?>
		...
		<footer>
			<div class="container-fluid">
				<p class="copyright">&copy; 2020 Brought To You By Team 18 (MCA)</p>
			</div>
		</footer>
	</div>
