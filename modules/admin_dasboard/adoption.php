...
<div class="main">
  ...
  <h2>Hello,  <span style="color: blue"> <?php echo $_SESSION['username']?></span> List of all Active Donors </h2> <br />
      ...
      while($row = $members->fetch_array()) {
       ?>
        ...
        <td><a href="../upload/<?php echo $row['id_proof'];?>" download>Download</a></td>
      		...
      		<td><button type="button" data-toggle="modal" data-target="#deletdonor<?php echo $row['ID']?>" class="btn btn-danger">Reject</button>
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-footer">
         ...
         <a href="reject_adoption.php?donor_id=<?php echo $row['ID'];?>"> <button type="button" class="btn btn-danger">Delete</button></a>
        </div>
      </div>
    </div>
  </div>
