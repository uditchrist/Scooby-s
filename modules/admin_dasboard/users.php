...
<div class="main">
  ...
  <h2>Hello,  <span style="color: blue"> <?php echo $_SESSION['username']?></span> Manage Users Here. </h2> <br />
  ...
  <table class="table table-bordered" id="donors">
    ...
    <tbody>
      <?php
      $members= $connection->query("SELECT * FROM userreg");
      while($row = $members->fetch_array()) {
       ?>
        ...
        <td><a href="../upload/<?php echo $row['id_proof'];?>" download>Download</a></td>
      		...
      		<td><button type="button" data-toggle="modal" data-target="#deletdonor<?php echo $row['user_ID']?>" class="btn btn-danger">Delete</button>
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-footer">
         ...
         <a href="delete_donor.php?donor_id=<?php echo $row['user_ID'];?>"> <button type="button" class="btn btn-danger">Delete</button></a>
        </div>
      </div>
    </div>
  </div>
