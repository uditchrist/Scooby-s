			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="search_donor.php" class=""><i class="lnr lnr-code"></i> <span>Search Veterinaries</span></a></li>
						<!-- <li><a href="blood_request.php" class=""><i class="lnr lnr-chart-bars"></i> <span>Patient request</span></a></li> -->
