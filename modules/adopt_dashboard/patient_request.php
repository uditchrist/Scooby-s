...
<div class="main">
  ...
  <table class="table table-bordered" id="donors">
    ...
    <tbody>
      <?php
      $members= $connection->query("SELECT * FROM adoption");
...
<td>
          ...
          if($row['Status'] == '1') { echo 'Activated'; } else {  echo 'Active'; }
           ?></button>
           <button type="button" class="btn btn-default" data-toggle="modal" data-target="#inactive<?php echo $row['ID']?>" <?php if($row['Status'] == '0') { echo 'disabled'; }?>><?php
          if($row['Status'] == '0') { echo 'Activated'; } else {  echo 'Reject'; }
           ?></button>
           <button type="button" data-toggle="modal" data-target="#deletdonor<?php echo $row['ID']?>" class="btn btn-danger">Delete</button>
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-footer">
         ...
         <a href="delete_donor.php?donor_id=<?php echo $row['ID'];?>"> <button type="button" class="btn btn-danger">Delete</button></a>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form action="edit_status.php?Status_id=<?php echo $row['ID']?>" method="post">
  ...
  <div class="modal fade" id="inactive<?php echo $row['ID']?>" role="dialog">
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        ...
        <div class="modal-body">
          ...
          <form action="reject_status.php?status_id2=<?php echo $row['ID']?>" method="post">
